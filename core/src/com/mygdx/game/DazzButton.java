...
public class DazzButton extends ScreenAdapter{
	...
	public int positionXFromRandomNumber(int number){
		if(number == 1){x=14;}
		else if(number == 2){x=142;}
		else if(number == 3){x=272;}
		else if(number == 4){x=14;}
		else if(number == 5){x=142;}
		else if(number == 6){x=272;}
		else if(number == 7){x=14;}
		else if(number == 8){x=142;}
		else if(number == 9){x=272;}
		return x;
	}
	
	public int positionYFromRandomNumber(int number){
		if(number == 1){y=32;}
		else if(number == 2){y=32;}
		else if(number == 3){y=32;}
		else if(number == 4){y=150;}
		else if(number == 5){y=150;}
		else if(number == 6){y=150;}
		else if(number == 7){y=270;}
		else if(number == 8){y=270;}
		else if(number == 9){y=270;}
		return y;
	}
}
